    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_category', models.CharField(default='美妆', max_length=256, verbose_name='商品种类')),
                ...
                ('free_lancer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lancer_orders3', to='account.user', verbose_name='接单人')),
                ('order_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owner_orders3', to='account.user', verbose_name='订单主人')),
            ],
        ),
    ]
